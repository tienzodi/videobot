...
Router::scope('/', function (RouteBuilder $routes) {
     ...
     */
	$routes->connect('/test', ['controller' => 'Bot', 'action' => 'test', 'home']);
	$routes->connect('/playVideo/:video_suggest_uid', ['controller' => 'Frontend', 'action' => 'playVideo'], ['pass'=>['video_suggest_uid']]);
